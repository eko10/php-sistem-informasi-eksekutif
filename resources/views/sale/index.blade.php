...
<div class="content">
    <div class="animated fadeIn">
        <div class="row">
            <div class="col-md-12">
                @php
                    $msg_save = Cookie::get('save_sale');
                    $msg_save = ($msg_save != '') ? $msg_save : '';
                    Cookie::queue(Cookie::forget('save_sale'));

                    // $msg_update = Cookie::get('update_Sale');
                    // $msg_update = ($msg_update != '') ? $msg_update : '';
                    // Cookie::queue(Cookie::forget('update_Sale'));
                @endphp
